...
Integration baseline: `20592a0eeb9924d021e3ec75ec28d27e2f971e9f`
...
- Targeted Wave C tests: `43 passed`, `0 failed`, `34.36s`.
- `tests/batch`: `326 passed`, `2 skipped`, `0 failed`, `35.81s`.
- Native lint: passed, no failures.
- Native type contract: passed, no failures.
- Full pytest: `1380 passed`, `41 skipped`, `3 failed`, `150.28s`.
...
The Wave C code hardening is complete, but the formal scientific deliverable is
...
explicit Provider authorization, and an external run root are supplied. Only a
physical 125/125 package that passes this validator may advance to human audit.
