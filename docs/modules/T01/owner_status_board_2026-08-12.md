...
| [#43](https://github.com/sage125-ai-scientist-team/SAGE125-AI-Scientist/pull/43) | EvidenceBundle SQLite read port（T08） | OPEN | yes | `b5a9e51…` | 跟进 sync integration（#39 后 behind） |
...
| #43 与最新 integration 同步 | 进行中（#39 已合入后） |
